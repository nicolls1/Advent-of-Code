...
def run():
  ...
  for command in commands:
    ...
    # print('start', container_stacks, container_stacks[move_start][-move_count:], move_count, move_start, move_end)
    container_stacks[move_end].extend(container_stacks[move_start][-move_count:])
    container_stacks[move_start] = container_stacks[move_start][:-move_count]
    # print('end', container_stacks)
